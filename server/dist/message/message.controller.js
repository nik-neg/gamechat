...
let MessageController = class MessageController {
    ...
    create(createMessageDto, userId, chatRoomId, userLanguage) {
        return this.messageService.create(createMessageDto, +userId, chatRoomId, userLanguage);
    }
    findAll(chatRoomId, userLanguage) {
...
__decorate([
    common_1.Post(':id/gamechatroom/:chatRoomId/:language'),
    __param(0, common_1.Body()),
    __param(1, common_1.Param('id')),
    __param(2, common_1.Param('chatRoomId')),
    __param(3, common_1.Param('language')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_message_dto_1.CreateMessageDto, Number, Number, String]),
    __metadata("design:returntype", void 0)
], MessageController.prototype, "create", null);
__decorate([
    common_1.Patch('gamechatroom/:id/all/:language'),
